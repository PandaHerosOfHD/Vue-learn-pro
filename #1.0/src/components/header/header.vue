<template>
    <div class="header">
        <div class="content-wrapper">
            ...
            <div class="content">
                ...
                <div v-if="seller.supports" class="support">
                    ...
                    <span class="text" v-html="seller.supports[0].description"></span>
                </div>
            </div>
        ...
        <div class="bulletin-wrapper" @click="showDetail">
            <span class="bulletin-title"></span><span class="bulletin-text" v-html="seller.bulletin"></span><span class="icon-keyboard_arrow_right"></span>
        </div>
